...
DEFAULT_JOIN_URL = "https://www.infojobs.net/madrid/analista-datos-microstrategy-con-ingles-ve01/of-i0e7e848e4b42d19894baef078e21a0?applicationOrigin=home-search-preferences"

def click_on_apply_infojobs(page, botton_name: str ="Apply Now"):
...
def apply_infojobs_website(url: str = DEFAULT_JOIN_URL):
    ...
    try:
        ...
        click_on_apply_infojobs(page, botton_name= "Inscribirme en esta oferta")
        ...
        click_on_apply_infojobs(page, botton_name= "APPLY NOW")

        # Pausa para verlo
        page.wait_for_timeout(4000)

        # 6) Volvemos a la pagina principal
        click_on_apply_infojobs(page, botton_name= "Apply For More Jobs")
        ...
        return True, msg, updated_page       
            
    except PwTimeout:
        return False, "⏱️ Timeout durante el login con Google.", url
    except Exception as e:
        return False, f"❌ Error Playwright: {e}", url
